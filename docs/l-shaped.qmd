...
$$
\begin{aligned}
    \min_{\mathbf{y}} \quad& \mathbf{f}^\top \mathbf{y} + \theta \\
    \text{s.t.} \quad & \mathbf{y} \in \mathbf{Y} \\
    & \mathbf{A} \mathbf{y} \geq \mathbf{b} \\
...
| Iteration | Upper bound | Lower bound | Objective function value of main problem | Value of theta | Sub or ray problem | Objective function value of sub/ray problem |
|------|--------|--------|-----------------|-------|-----------|-----------------|
