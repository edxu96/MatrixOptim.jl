...
```{mermaid}
flowchart LR
    BEGIN --> main(main problem)
    main --> candidate
    candidate --> sub1(sub problem 1)
    candidate --> sub2(sub problem 2)
    main --> |lower bound| convergence{tolerance}
    sub1 --> status1{solution status 1}
    sub2 --> status2{solution status 2}
