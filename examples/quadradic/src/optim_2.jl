...
function cal_dis_profit(h_mt, y_mi, y_mj, y_paper_m, z_mik, z_mjk, z_paper_mk,
  ...
  println("dis_profit = $(round(dis_profit; digit=4)).")
end


function print_result(result_h_mt, result_y_mi, result_y_mj, result_y_paper_m,
  ...
  for m=1:3
    ...
    ## discounted profits
    cal_dis_profit(h_mt, y_mi, y_mj, y_paper_m, z_mik, z_mjk, z_paper_mk,
...
function optim_2(alpha_t, beta_t, a_i, b_i, e_i, c_i, r_saw, r_plywood, a_j,
  ...
  print_result(result_h_mt, result_y_mi, result_y_mj, result_y_paper_m,
    result_z_mik, result_z_mjk, result_z_paper_mk, alpha_t, beta_t, a_i, b_i,
    e_i, c_i, r_saw, r_plywood, a_j, c_j, r_j, a_paper_t, b_paper_j, c_paper,
    r_paper, gamma_ik, delta_ik, gamma_jk, delta_jk, gamma_paper_k,
    delta_paper_k, p_fuel, sigma, omega_i, omega_j, omega_paper, nu_saw,
